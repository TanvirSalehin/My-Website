...
<div class="alert alert-danger" role="alert">
  Stats of Corona Virus update in Bangladesh !  Brilliant things ! --- Check it out!!!
</div>
<div class="jumbotron">
  <h1 class="display-4">Hello, Guys!</h1>
  <p class="lead">.</p>
  <hr class="my-4">
  <p>For the real stats of COVID-19 , click the button below.</p>
  <a class="btn btn-success btn-lg" href="#" role="button">Corona Virus Stats</a>
</div>
